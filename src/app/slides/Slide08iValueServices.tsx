  ...
  return (
    <div className="flex items-center justify-center min-h-full h-auto bg-[#030211] p-6 md:p-12 overflow-y-auto md:overflow-hidden relative text-white">
      ...
      <div className="max-w-6xl w-full relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:p-12 w-full">
          {serviceCategories.map((cat, index) => (
            ...
            >
              ...
              <div className="relative min-h-full h-auto bg-slate-900/40 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-6 md:p-12 flex flex-col items-center text-center hover:bg-slate-900/60 transition-all duration-500 hover:border-white/20 pb-12">
