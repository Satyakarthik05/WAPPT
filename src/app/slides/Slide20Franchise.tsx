...
export function Slide20Franchise() {
  return (
    <div className="flex items-center justify-center min-h-full bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 p-6 overflow-y-auto md:overflow-hidden relative">
      <div className="max-w-[1400px] w-full h-full flex flex-col relative z-10">
        ...
        <div className="flex-1 grid grid-cols-[1fr_1.2fr_1fr] gap-4 md:p-8 items-center min-h-0">
          ...
          >
            ...
            <div className="w-full bg-gradient-to-b from-white/20 to-white/5 backdrop-blur-2xl rounded-[3.5rem] p-10 border border-white/30 shadow-[0_0_80px_rgba(168,85,247,0.4)] relative z-10 overflow-y-auto md:overflow-hidden text-center group">
               ...
               <h2 className="text-2xl md:text-4xl font-black text-white uppercase tracking-wider mb-2">Local Partner</h2>
               <p className="text-purple-400 font-bold text-sm tracking-[0.2em] uppercase mb-10">Strategic Franchisee</p>

               <div className="bg-white/10 rounded-3xl p-4 md:p-8 border border-white/20 shadow-inner group-hover:border-purple-400/50 transition-all duration-300">
