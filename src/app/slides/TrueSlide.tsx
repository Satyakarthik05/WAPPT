...
export function TrueSlide() {
  return (
    <div className="flex items-center justify-center min-h-full bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 p-4 md:p-6 overflow-y-auto md:overflow-y-auto md:overflow-hidden relative">
      <div className="max-w-[1400px] w-full h-full flex flex-col relative z-10 py-10 md:py-0">
        <motion.h1
          initial={{ y: -20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          className="text-2xl md:text-2xl md:text-4xl font-bold text-white text-center mb-8 uppercase tracking-widest"
        >
          True Perspective
        </motion.h1>

        <div className="flex-1 grid grid-cols-1 md:grid-cols-[1fr_2fr_1fr] gap-4 md:p-8 md:gap-6 md:p-12 items-center min-h-0 relative">
          ...
          >
            <div className="h-full max-h-auto max-h-[580px] aspect-[9/19.5] bg-slate-800 rounded-[2.5rem] p-2 border-4 border-slate-700 shadow-[0_0_50px_rgba(59,130,246,0.3)] relative group">
          ...
          <div className="flex flex-col gap-6 md:p-12 h-full justify-center relative z-10">
            <motion.div
          ...
          <motion.div
            ...
            className="h-full flex items-center justify-center min-h-0 py-4 relative z-10"
          >
            <div className="h-full max-h-auto max-h-[580px] aspect-[9/19.5] bg-slate-800 rounded-[2.5rem] p-2 border-4 border-slate-700 shadow-[0_0_50px_rgba(79,70,229,0.3)] relative group">
              <div className="w-full min-h-full h-auto bg-black rounded-[2.1rem] overflow-y-auto md:overflow-hidden relative">
