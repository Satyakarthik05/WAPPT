...
import eastgodavari from "../../assests/eastgodavari.jpg";
...
export function AP4() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("ap4-position");
    if (saved) {
  ...
  const handleDragEnd = () => {
    ...
    setCoords(newCoords);
    localStorage.setItem("ap4-position", JSON.stringify(newCoords));
  };
