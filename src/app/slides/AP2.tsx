...
import vizianagaram from "../../assests/vizianagaram.jpg";
...
export function AP2() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("ap2-position");
    if (saved) {
  ...
  const handleDragEnd = () => {
    ...
    setCoords(newCoords);
    localStorage.setItem("ap2-position", JSON.stringify(newCoords));
  };
